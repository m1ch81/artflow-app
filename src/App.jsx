    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-950 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-slate-800 rounded-3xl p-8 shadow-xl">
          ...
          <div className="mt-6 p-4 bg-slate-700/50 rounded-xl border border-slate-600 space-y-3">
            <div>
              <p className="text-xs font-semibold text-blue-400 text-center mb-2">Research Study</p>
              <p className="text-xs text-slate-300 text-center">
                ArtFlow: An Art Therapy Application for Managing Anxiety in Teenagers
              </p>
              <p className="text-xs text-slate-400 text-center mt-1">
                Research Paper by Johann Christian Banayo
              </p>
            </div>
